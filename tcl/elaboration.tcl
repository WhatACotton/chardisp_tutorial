...
set_property -name "ip_repo_paths" -value "./vivado/ip_repo" -objects $obj


read_xdc ./vivado/srcs/constr/chardisp.xdc
# import_ip [glob ./vivado/srcs/xci/*.xci]
# synth_ip -force
# upgrade_ip  -vlnv  user.org:user:chardisp_ip:1.0 [get_ips chardisp_chardisp_ip_0_0]

set outputDir ./synth_tmp
file mkdir $outputDir
# print get_parts
# puts "get_parts: [get_parts]"
# set_part digilentinc.com:zybo-z7-20:part0:1.0

# step#1: Setup design sources and constraints.
# check whether the design is already created
set design_name chardisp
source ./vivado/srcs/bd/$design_name.tcl
generate_target all [get_files  .srcs/sources_1/bd/chardisp/chardisp.bd] -force

# # check whether the wrapper is already created

make_wrapper -files [get_files   .srcs/sources_1/bd/chardisp/chardisp.bd] -top -force


read_verilog -sv [ glob .gen/sources_1/bd/chardisp/hdl/chardisp_wrapper.v ]
set top_module_name chardisp_wrapper
