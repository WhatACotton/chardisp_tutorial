...
################################################################
# This is a generated script based on design: chardisp
#
...
proc create_root_design { parentCell } {
  ...
  set HDMI_N [ create_bd_port -dir O -from 2 -to 0 HDMI_N ]
  set HDMI_P [ create_bd_port -dir O -from 2 -to 0 HDMI_P ]

  # Create instance: chardisp_ip_0, and set properties
  set chardisp_ip_0 [ create_bd_cell -type ip -vlnv user.org:user:chardisp_ip:1.0 chardisp_ip_0 ]
  ...
  set_property CONFIG.kClkRange {5} $hdmi_vga_0
...
\
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M00_AXI [get_bd_intf_pins chardisp_ip_0/S00_AXI] [get_bd_intf_pins ps7_0_axi_periph/M00_AXI]

  # Create port connections
  connect_bd_net -net chardisp_ip_0_PCK [get_bd_pins chardisp_ip_0/PCK] [get_bd_pins hdmi_vga_0/PCK]
  connect_bd_net -net chardisp_ip_0_VGA_B [get_bd_pins chardisp_ip_0/VGA_B] [get_bd_pins hdmi_vga_0/IN_VGA_B]
  connect_bd_net -net chardisp_ip_0_VGA_DE [get_bd_pins chardisp_ip_0/VGA_DE] [get_bd_pins hdmi_vga_0/IN_VGA_DE]
  connect_bd_net -net chardisp_ip_0_VGA_G [get_bd_pins chardisp_ip_0/VGA_G] [get_bd_pins hdmi_vga_0/IN_VGA_G]
  connect_bd_net -net chardisp_ip_0_VGA_HS [get_bd_pins chardisp_ip_0/VGA_HS] [get_bd_pins hdmi_vga_0/IN_VGA_HS]
  connect_bd_net -net chardisp_ip_0_VGA_R [get_bd_pins chardisp_ip_0/VGA_R] [get_bd_pins hdmi_vga_0/IN_VGA_R]
  connect_bd_net -net chardisp_ip_0_VGA_VS [get_bd_pins chardisp_ip_0/VGA_VS] [get_bd_pins hdmi_vga_0/IN_VGA_VS]
  connect_bd_net -net hdmi_vga_0_HDMI_CLK_N [get_bd_ports HDMI_CLK_N] [get_bd_pins hdmi_vga_0/HDMI_CLK_N]
  connect_bd_net -net hdmi_vga_0_HDMI_CLK_P [get_bd_ports HDMI_CLK_P] [get_bd_pins hdmi_vga_0/HDMI_CLK_P]
  connect_bd_net -net hdmi_vga_0_HDMI_N [get_bd_ports HDMI_N] [get_bd_pins hdmi_vga_0/HDMI_N]
  connect_bd_net -net hdmi_vga_0_HDMI_P [get_bd_ports HDMI_P] [get_bd_pins hdmi_vga_0/HDMI_P]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins chardisp_ip_0/s00_axi_aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_50M/slowest_sync_clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins hdmi_vga_0/nRST] [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_50M/ext_reset_in]
  connect_bd_net -net rst_ps7_0_50M_peripheral_aresetn [get_bd_pins chardisp_ip_0/s00_axi_aresetn] [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_50M/peripheral_aresetn]

  # Create address segments
  assign_bd_address -offset 0x43C00000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs chardisp_ip_0/S00_AXI/S00_AXI_reg] -force
